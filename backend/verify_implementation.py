...
def verify_files():
    ...
    with open(os.path.join(project_root, 'static', 'dashboard.html'), 'r') as f:
    ...
    with open(os.path.join(project_root, 'static', 'backtesting.js'), 'r') as f:
        bt_content = f.read()
    ...
    with open(os.path.join(project_root, 'backend', 'routes.py'), 'r') as f:
    ...
    with open(os.path.join(project_root, 'static', 'monte_carlo.js'), 'r') as f:
        mc_content = f.read()
    ...
    with open(os.path.join(project_root, 'system_prompt.txt'), 'r') as f:
        sp_content = f.read()
    ...
    print("1. Run: python -m backend.app")
